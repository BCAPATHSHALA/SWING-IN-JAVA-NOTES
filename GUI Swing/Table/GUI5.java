// PROGRAM:5 ADVANCED TOPIC:01 JTable PART:04 Delete row
package guiFolder;
import javax.swing.*;
import java.awt.*;
...
class MyTable extends JFrame
{
	...
	public MyTable()
	{
			...
			public void actionPerformed(ActionEvent  e)
			{
				...
				else
				{
					...
					if(status==JOptionPane.YES_OPTION)
					{
						...
						// row delete hone ke bad textfield null ho jayen uske liye code
						t1.setText(null);
						t2.setText(null);
						t3.setText(null);
					}
		...
		// CTRL ke sath agar multiple row select kare to 
		// multi row select nhi honi chaiye kyunki delete krte time error aa skta hai
